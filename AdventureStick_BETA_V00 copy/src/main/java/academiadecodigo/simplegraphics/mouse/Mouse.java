package academiadecodigo.simplegraphics.mouse;
...
public class Mouse implements MouseListener, MouseMotionListener {
    ...
    public void mouseClicked(MouseEvent e) {
        handler.mouseClicked(new academiadecodigo.simplegraphics.mouse.MouseEvent(e.getX(), e.getY()));
    }

    @Override
    public void mouseMoved(MouseEvent e) {
        handler.mouseMoved(new academiadecodigo.simplegraphics.mouse.MouseEvent(e.getX(), e.getY()));
    }

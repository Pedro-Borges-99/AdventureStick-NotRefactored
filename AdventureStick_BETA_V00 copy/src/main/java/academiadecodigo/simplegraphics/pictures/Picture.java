package academiadecodigo.simplegraphics.pictures;

import academiadecodigo.simplegraphics.graphics.Canvas;
import academiadecodigo.simplegraphics.graphics.Color;
import academiadecodigo.simplegraphics.graphics.Movable;
import academiadecodigo.simplegraphics.graphics.Shape;
...
public class Picture implements Shape, Movable {
     ...
     */
    public academiadecodigo.simplegraphics.graphics.Color getColorAt(int i) {
     ...
     */
    public void setColorAt(int i, academiadecodigo.simplegraphics.graphics.Color color) {
        if (image == null || i < 0 || i >= pixels()) {
            throw new IndexOutOfBoundsException("" + i);
        } else {
     ...
     */
    public academiadecodigo.simplegraphics.graphics.Color getColorAt(int x, int y) {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight()) {
            throw new IndexOutOfBoundsException("(" + x + "," + y + ")");
        } else {
            int rgb = image.getRGB(x, y) & 0xFFFFFF;
            return new academiadecodigo.simplegraphics.graphics.Color(rgb / 65536, (rgb / 256) % 256, rgb % 256);
        }
    }
    ...
    public void setColorAt(int x, int y, Color color) {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight()) {
            ...
            academiadecodigo.simplegraphics.graphics.Canvas.getInstance().repaint();
        }
    }
     ...
     */
    public void draw() {
        academiadecodigo.simplegraphics.graphics.Canvas.getInstance().show(this);
    }
     ...
     */
    public void delete() {
        academiadecodigo.simplegraphics.graphics.Canvas.getInstance().hide(this);
    }
